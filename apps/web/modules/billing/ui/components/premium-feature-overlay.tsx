...
import { BookOpenIcon, BotIcon, GemIcon, LucideIcon, MicIcon, PaletteIcon, UsersIcon } from 'lucide-react'
...
export function PremiumFeatureOverlay({ children }: PremiumFeatureOverlayProps) {
      ...
      <div className="absolute inset-0 z-40 flex items-center justify-center p-4">
        <Card className='w-full max-w-md'>
          ...
          <CardContent className='space-y-6'>
            ...
            <Button className='w-full' size="lg" onClick={() => router.push('/billing')}>View Plans</Button>
          </CardContent>
        </Card>
      </div>
    </div>
