...
export type AIMessageProps = React.ComponentProps<"div"> & {
  from: "user" | "assistant";
};
...
export type AIMessageContentProps = React.ComponentProps<"div">;
...
export type AIMessageAvatarProps = React.ComponentProps<typeof Avatar> & {
  src: string;
  name?: string;
};
